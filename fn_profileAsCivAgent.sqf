 ...
 * Requires: scripts\fn_setCivilianInventory.sqf
 *
 * Arguments:
 * 0: Unit <OBJECT>
 *
 * Example:
 * this execVM "scripts\fn_profileAsCivAgent.sqf"
 *
 */
...
private _onAct    = format ["_veh = createAgent ['%1', %2, [], 0, 'CAN_COLLIDE']; [{_this#0 setVectorDirAndUp [%3, %4]; _this#0 setPosASL _this#1; _this#0 execVm 'scripts\fn_setCivilianInventory.sqf'}, [_veh, %2]] call CBA_fnc_execNextFrame; thisTrigger setVariable ['profile', _veh call BIS_fnc_netId]", _classname, _postion, _vectorDir, _vectorUp];
